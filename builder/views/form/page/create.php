...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="px-2">
	...
	<div class="form-group">
		<label for="access_perms_create_page">Access Permission(s)</label>
		<input type="text" class="form-control" id="access_perms_create_page" name="access_perms" placeholder="$user->rights->mymodule->create" value="<?php echo $options['access_perms']; ?>">
	</div>
