...
$dolibase_config['module_name']     = 'Books';
...
$dolibase_config['module_folder']   = 'books'; // Advice: never use underscores in module folder name to avoid many problems especially with top menu icon, module widgets etc..

$dolibase_config['module_picture']  = 'books.png'; // Your picture file should have 'object_' prefix to work
...
$dolibase_config['rights_class']    = 'books'; // key to reference module (for permissions, menus, etc.)
