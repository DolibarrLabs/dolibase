...
$dolibase_config['module'] = array(
	...
	'version'      => '1.1.0', // possible values: 'development', 'experimental', 'dolibarr' or version
...
$dolibase_config['author'] = array(
	...
	'dolistore_url' => 'https://www.dolistore.com/en/search?orderby=position&orderway=desc&search_query=axel-dev'
);
